...
<div class="form-group">
  ...
  <div class="col-md-4">
	...
	<input id="randevu_ad" name="randevu_ad"  type="text" value="" placeholder="Adınızı giriniz" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <input id="randevu_soyad" name="randevu_soyad"  type="text" value=""  placeholder="Soyadınızı giriniz" class="form-control input-md" required="">
